...
class DeviceInfo {
  ...
  set(options) {
    ...
    if (options.vendorId != null) {
      enforce(typeof options.vendorId === 'number', 'vendorId', 'number');
      this.vendorId = options.vendorId;
    }

    if (options.productId != null) {
      enforce(typeof options.productId === 'number', 'productId', 'number');
      this.productId = options.productId;
    }

    if (options.manufacturerName != null) {
      enforce(typeof options.manufacturerName === 'string',
        'manufacturerName', 'string');
      this.manufacturerName = options.manufacturerName;
    }

    if (options.productName != null) {
      enforce(typeof options.productName === 'string', 'productName', 'string');
      this.productName = options.productName;
    }

    if (options.serialNumber != null) {
      enforce(typeof options.serialNumber === 'string',
        'serialNumber', 'string');
